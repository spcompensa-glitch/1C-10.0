# -*- coding: utf-8 -*-
"""
Testes de Integração - Banco de Dados (Corrigido)
===============================================
...
class TestDatabaseIntegration:
    ...
    def test_database_security_validation(self):
        ...
        # Verifica que não tem senha na URL (em ambiente de dev é aceitável)
        if "localhost" in db_url or "127.0.0.1" in db_url:
            # Em ambiente de desenvolvimento, é aceitável ter senhas simples
            assert "postgresql://" in db_url
        else:
            # Em produção, não deve ter senhas expostas
    ...
    def test_database_connection_simulation(self):
        ...
        # Verifica se tem componentes mínimos
        if "postgresql://" in db_url:
            assert "@" in db_url  # usuário@servidor
            assert "/" in db_url  # /database
