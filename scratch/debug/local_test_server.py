...
# -*- coding: utf-8 -*-
"""
Servidor Local de Teste para Sistema de Autenticação
===================================================

Servidor local para testar o sistema de autenticação e frontend
...
logger = logging.getLogger("LocalTestServer")

# Criar app FastAPI
app = FastAPI(
    title="1Crypten Local Test Server",
    description="Servidor local para testar sistema de autenticação",
    version="1.0.0"
)
...
async def root():
    """Endpoint raiz"""
    return {
        "message": "1Crypten Local Test Server",
        "version": "1.0.0",
        "mode": "local_test",
