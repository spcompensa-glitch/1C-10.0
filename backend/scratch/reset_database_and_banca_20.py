...
async def reset_banca_and_db_to_20():
    ...
    # 2. Query para redefinir a banca status para 20 dólares conforme pedido
    query_banca = """
    ...
    try:
        async with engine.connect() as conn:
            ...
            print("Redefinindo banca para $20.00 de saldo inicial...")
            ...
            await conn.commit()
            print("[SUCESSO ABSOLUTO] O banco de dados Postgres do Railway foi completamente limpo e a banca foi resetada para $20.00!")
...
if __name__ == "__main__":
    asyncio.run(reset_banca_and_db_to_20())
