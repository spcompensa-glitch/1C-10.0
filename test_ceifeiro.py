...
mock_bybit_ws = MagicMock()
mock_bybit_ws.get_cvd_score_time = MagicMock(return_value=0)
mock_bybit_ws.rsi_cache = {}

mock_settings = MagicMock()
mock_settings.BYBIT_EXECUTION_MODE = "PAPER"

mock_signal_generator = MagicMock()

with patch.dict("sys.modules", {
    "services.bybit_ws":         MagicMock(bybit_ws_service=mock_bybit_ws),
...
async def test_harvest_opportunity():
    ...
    mock_bybit_ws.get_cvd_score_time.return_value = 0
    mock_bybit_ws.rsi_cache = {"XRPUSDT": 55}
    ...
    mock_bybit_ws.get_cvd_score_time.return_value = -20000  # CVD negativo = exaustao
    mock_bybit_ws.rsi_cache = {"XRPUSDT": 78}
    ...
    mock_bybit_ws.get_cvd_score_time.return_value = 50000  # momentum MUITO forte
    mock_bybit_ws.rsi_cache = {"XRPUSDT": 60}
    ...
    mock_bybit_ws.get_cvd_score_time.return_value = 0
    mock_bybit_ws.rsi_cache = {"XRPUSDT": 50}
    agent._harvest_history.pop("XRPUSDT", None)
    ...
    mock_bybit_ws.rsi_cache = {"XRPUSDT": 87}
    agent._harvest_history.pop("XRPUSDT", None)
